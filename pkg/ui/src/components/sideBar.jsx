      ...
      >
        ...
        <nav className="flex flex-col md:space-y-2 lg:space-y-4 xl:space-y-2 pt-6 w-full">
          ...
          <div className="w-full mb-2">
            ...
            {settingsOpen && (
              <div className="pl-6 pr-1 space-y-2 mt-2 md:max-h-30 overflow-y-auto scrollbar-thin scrollbar-thumb-orange-500 scrollbar-track-orange-400">
        ...
        <footer className="mt-auto text-sm flex flex-col items-center space-y-0">
          <h4 className="mt-1">v0.1.1</h4>
          <img src={Logo2} alt="Footer Logo" className="w-80 h-20 object-contain md:w-80 md:h-20" loading="lazy" />
        </footer>
      </div>
